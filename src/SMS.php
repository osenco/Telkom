...
class SMS extends Service
{
	...
	public function listAccounts($value='')
	{
		# code...
	}
    ...
    public static function send(string $receiver, string $receiver_type, int $amount = 10, $command = '',  string $reference = 'TRX', string $remarks = '')
    {
        ...
        $endpoint 	= ($env == 'live')
			? 'https://api.safaricom.co.ke/telkom/b2b/v1/paymentrequest'
			: 'https://sandbox.safaricom.co.ke/telkom/b2b/v1/paymentrequest';
...
//         {
//           "Key":"QueueTimeoutURL",
//           "Value":"https://internalsandbox.safaricom.co.ke/telkom/b2bresults/v1/submit"
//         },
//         {
//           "Key":"Occasion"
//         }
